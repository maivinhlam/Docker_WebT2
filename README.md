...
- Copy file .env.example sang một file mới và đặt tên là .env

- Sửa các giá trị nếu muôn 
...
Nếu sử dụng php.56, thì thay

`fastcgi_pass unix:/run/php/php7.3-fpm.sock;` thành `fastcgi_pass unix:/var/run/php/php5.6-fpm.sock;`
